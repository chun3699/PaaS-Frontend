...
RUN rm -rf ./* && \
    git clone -b main https://chun3699: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@github.com/chun3699/PaaS-Frontend.git .
